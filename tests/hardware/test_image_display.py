"""Test script to display icons and animations on the SSD1309 display."""
...
from thekilngod.display import KilnDisplay
...
def test_logo(display):
    """Test displaying the Kiln God logo animation."""
...
def test_pottery(display):
    """Test displaying the pottery flame animation."""
    ...
    start_time = time.time()
    while time.time() - start_time < 10:
        # Ping-pong the flame frames to create a flicker effect.
        sequence = [pottery, *flame_frames, *flame_frames[::-1]]
